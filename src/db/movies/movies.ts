...
let movieDB: Movie[] = [
  {
    ...
    coverImage:
      'https://upload.wikimedia.org/wikipedia/sr/9/95/Forrest_Gump_DVD.jpg',
    description:
  ...
  },
  {
    ...
    releaseDate: new Date(2012, 5, 11),
    coverImage:
      'https://upload.wikimedia.org/wikipedia/sr/c/cb/The_Shawshank_Redemption.jpg',
    description:
      'A reluctant Hobbit, Bilbo Baggins, sets out to the Lonely Mountain with a spirited group of dwarves to reclaim their mountain home, and the gold within it from the dragon Smaug.',
    averageRating: 4.6,
  ...
  },
  {
    ...
    coverImage:
      'https://m.media-amazon.com/images/I/81LX+JlavLL._AC_SY679_.jpg',
    description:
  ...
  },
  {
    ...
    coverImage:
      'https://m.media-amazon.com/images/I/51ILUdMuieL._AC_SY445_.jpg',
    description:
  ...
  },
  {
    ...
    coverImage:
      'https://images0.persgroep.net/rcs/yYmINRIB7X7B85a7Lh4xXPS5L9o/diocontent/131078578/_crop/0/0/317/450/_fitwidth/763?appId=93a17a8fd81db0de025c8abd1cca1279&quality=0.8',
    description:
  ...
  },
  {
    ...
    coverImage:
      'https://m.media-amazon.com/images/M/MV5BYmI1NGIwNzYtOTVlMS00ZGYwLWE0ZTktYzVmMGVlMmRmN2QxXkEyXkFqcGdeQXVyNTA4NzY1MzY@._V1_.jpg',
    description:
